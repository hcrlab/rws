...
class Pr2Claimer(object):
    def __init__(self, blueprint, user_verifier):
        ...
        self._blueprint.add_url_rule('/claim', 'claim_robot', self.claim_robot, methods=['POST'])
        self._blueprint.add_url_rule('/start', 'start_robot', self.start_robot, methods=['POST'])
        self._blueprint.add_url_rule('/stop', 'stop_robot', self.stop_robot, methods=['POST'])
        self._blueprint.add_url_rule('/check', 'check_robot_claim', self.check_robot_claim)
